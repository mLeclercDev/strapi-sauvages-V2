...
export interface ApiAgenceAgence extends Struct.SingleTypeSchema {
...
export interface ApiCarouselDeLogoCarouselDeLogo
  extends Struct.SingleTypeSchema {
  collectionName: 'carousel_de_logos';
  info: {
    displayName: 'Carousel de logo';
    pluralName: 'carousel-de-logos';
    singularName: 'carousel-de-logo';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Label: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Nos clients'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carousel-de-logo.carousel-de-logo'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Titre: Schema.Attribute.Component<'ui.titre', false> &
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Formulaires: Schema.Attribute.DynamicZone<['contact.formulaire']>;
    HeroContact: Schema.Attribute.Component<'contact.hero-contact', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
...
export interface ApiExpertiseListingExpertiseListing
  extends Struct.SingleTypeSchema {
  collectionName: 'expertise_listings';
  info: {
    displayName: 'Expertise listing';
    pluralName: 'expertise-listings';
    singularName: 'expertise-listing';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::expertise-listing.expertise-listing'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Adresse: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2 rue de la Mabilais 35000 Rennes'>;
    Bouton: Schema.Attribute.Component<'ui.bouton', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Item: Schema.Attribute.Component<'footer.footer-navigation-item', true>;
    Label: Schema.Attribute.String & Schema.Attribute.DefaultTo<'contact'>;
    Label2: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'L\u2019agence'>;
    Lien: Schema.Attribute.Component<'footer.footer-navigation-2', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Logo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    Navigation: Schema.Attribute.Component<'header.navigation-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiManifesteManifeste extends Struct.SingleTypeSchema {
  collectionName: 'manifestes';
  info: {
    displayName: 'Manifeste';
    pluralName: 'manifestes';
    singularName: 'manifeste';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjetProjet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color_section: Schema.Attribute.Component<'projet.color-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    sections: Schema.Attribute.Component<'projet.sections', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::carousel-de-logo.carousel-de-logo': ApiCarouselDeLogoCarouselDeLogo;
      'api::client.client': ApiClientClient;
      'api::contact.contact': ApiContactContact;
      'api::expertise-listing.expertise-listing': ApiExpertiseListingExpertiseListing;
